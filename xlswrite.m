...
## 3rd argument is assumed to refer to a sheet if it is a numeric value
...
## If @var{wsh} is enetered as numeric value, it refers to the position in
## the total number of visible sheets in the spreadsheet window, incl. e.g., 
## chartsheets.
##
